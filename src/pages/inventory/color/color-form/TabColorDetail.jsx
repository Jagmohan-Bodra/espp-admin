    ...
    <div className={`${cssClass}`}>
      ...
      <RowAuto>
        <ColAuto desktop={12} tablet={24}>
          <RowLabelStatus label="Color Name" name="name" nameActive={editField}>
            <InputAreaBur
              onlyForm={onlyForm}
              value={data.name}
          ...
          <RowLabelStatus label="Color Code" name="code" nameActive={editField}>
            <InputAreaBur
              onlyForm={onlyForm}
              value={data.code}
...
export default withRouter(TabColorDetail);
