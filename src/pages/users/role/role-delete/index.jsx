...
import {deleteRole, getRoleList, reqIsDelete} from '~/reduxs/role/action';
import ComfirmModel from '~/components/public/modals/ComfirmModel';
import {trans} from '~/components/public/Translate';
import {USER_ROLE_DELETE_PERMISSION_KEY} from '~/constants/permissions';
...
const DeleteModal = (props) => {
  ...
  const isDelete = useSelector((state) => state.role.isDelete);
  const ACCESS = {
    DELETE: isAccess(USER_ROLE_DELETE_PERMISSION_KEY),
  };
  const handleDeleteSubmit = () => {
    dispatch(deleteRole(obj._id));
  };
